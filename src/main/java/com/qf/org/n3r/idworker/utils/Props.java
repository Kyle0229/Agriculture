package com.qf.org.n3r.idworker.utils;
...
import static com.qf.org.n3r.idworker.utils.Serializes.closeQuietly;

public class Props {
    static Logger log = LoggerFactory.getLogger(com.qf.org.n3r.idworker.utils.Props.class);

    public static Properties tryProperties(String propertiesFileName, String userHomeBasePath) {
        Properties properties = new Properties();
        InputStream is = null;
        try {
            is = com.qf.org.n3r.idworker.utils.Props.tryResource(propertiesFileName, userHomeBasePath, Silent.ON);
    ...
    public static InputStream classpathResource(String resourceName) {
        return com.qf.org.n3r.idworker.utils.Props.class.getClassLoader().getResourceAsStream(resourceName);
    }
