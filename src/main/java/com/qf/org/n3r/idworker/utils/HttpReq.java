...
public class HttpReq {
    ...
    Logger logger = LoggerFactory.getLogger(org.n3r.idworker.utils.HttpReq.class);

    public HttpReq(String baseUrl) {
        this.baseUrl = baseUrl;
    }

    public static com.qf.org.n3r.idworker.utils.HttpReq get(String baseUrl) {
        return new com.qf.org.n3r.idworker.utils.HttpReq(baseUrl);
    }

    public com.qf.org.n3r.idworker.utils.HttpReq req(String req) {
        this.req = req;
        return this;
    }

    public com.qf.org.n3r.idworker.utils.HttpReq param(String name, String value) {
