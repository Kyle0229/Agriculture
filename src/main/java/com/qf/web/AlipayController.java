...
public class AlipayController {
	...
	@ResponseBody
	public Orders createOrder(HttpSession session) throws Exception {
	...
	@ResponseBody
	public String goAlipay(@RequestBody Payment payment) throws Exception {
		...
		//付款金额，必填
		String total_amount = payment.getOrderAmount();
		//订单名称，必填
		String subject = "农产品";
		//商品描述，可空
